...
class StatisticsControllerTest {
    ...
    void searchTransactions_Success() throws Exception {
        ...
        when(transactionService.searchTransactions(any(), any(), any(), any(), any()))
                .thenReturn(transactions);

        mockMvc.perform(get("/api/v1/statistics/transactions/search")
    ...
    void getAnnualSummary_Success() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/statistics/summary/annual")
                        .param("year", "2025")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
